...
function MyDropdown() {
  return (
    <div className="text-right relative font-white">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md  font-medium hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            Export
            <ChevronDownIcon
...
function MyPopover() {
  return (
    <Popover className="relative font-serif">
      ...
      <Popover.Panel className="absolute z-10 w-96 h-fit border border-purple-500 right-0 bg-black">
...
<div>* Import/Export to SpreadSheet, Pdf, Application_URL</div>
