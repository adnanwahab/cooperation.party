...
export default function AnabelleMap (props){

//   return Object.entries(props.data).map((pair) => {
//     return <JustMap title={pair[0]} data={pair[1]} left={0} />
//   })
//   return props.data
console.log('AnabelleMap', 13)
const centroid = [-95.731003, 29.746700]
...
const layers = []
    ...
    <iframe width="1000" height="500" src="https://webviz.io/app/?demo=&seek-to=1490150295.229484365"></iframe>
